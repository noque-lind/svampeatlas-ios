...
class FavoritesBackground: MushroomDataBackgroundView {
    ...
    var contentStackView: UIStackView = {
       let stackView = UIStackView()
        ...
        let label = UILabel()
        label.text = "Du har ikke gjort nogle arter til en favorit endnu, swipe til venstre på en art for at gøre det."
